#!/usr/bin/env python
"""
Create a STIR projection object from DICOM data.
...
def main(dicom_file: str) -> None:
    ...
    ax.set_title("STIR projection (view 0)")
    ax.axis("off")
    plt.tight_layout()
    plot_path = output_dir / "stir_from_dicom_summary.png"
